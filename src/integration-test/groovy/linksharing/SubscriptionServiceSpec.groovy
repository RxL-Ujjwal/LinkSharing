...
class SubscriptionServiceSpec extends Specification {
    ...
    private Long setupData() {
        ...
        //new linksharing.Subscription(...).save(flush: true, failOnError: true)
        //new linksharing.Subscription(...).save(flush: true, failOnError: true)
        //linksharing.Subscription subscription = new linksharing.Subscription(...).save(flush: true, failOnError: true)
        //new linksharing.Subscription(...).save(flush: true, failOnError: true)
        //new linksharing.Subscription(...).save(flush: true, failOnError: true)
