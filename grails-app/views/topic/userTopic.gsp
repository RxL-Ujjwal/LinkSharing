...
<body>
<h1 style="margin-top: 15px;">User Topics</h1>
...
<div class="container" style="position: center">
    <div class="col-md-5 rounded-top topic" style="height:auto;overflow-y: scroll">
        ...
        <nav class="navbar navbar-expand-sm bg-secondary mynavl" style="position: relative">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <b class="ls e">User Topics>
                </li>
            </ul>
        </nav>

        <div style="">
            <g:each in="${userTopicsList}" var="s">
                <g:render template="/topic/topic" model="[topic:s]"></g:render>
            </g:each>
        </div>
